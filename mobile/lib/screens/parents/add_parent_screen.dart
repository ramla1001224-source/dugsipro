...
class _AddParentScreenState extends State<AddParentScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await _api.post(ApiConfig.parents, data: data);

      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('Waalidka si sax ah ayaa loo diwaangeliyey'),
