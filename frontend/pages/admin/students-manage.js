...
export default function AdminStudents() {
    ...
    const [formData, setFormData] = useState({ name: '', password: '', class: '', classId: '', sectionId: '', phone: '', address: '', gender: '', scholarship: 'none', parentPhone: '' })
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setShowModal(false)
            setFormData({ name: '', password: '', class: '', classId: '', sectionId: '', phone: '', address: '', gender: '', scholarship: 'none', parentPhone: '' })
            fetchStudents()
