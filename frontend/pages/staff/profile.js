        ...
        <Layout title="My Profile">
            <div className="max-w-4xl mx-auto space-y-8 pb-20">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-4">
                                <span className="px-4 py-2 bg-slate-900 text-white rounded-xl text-xs font-black uppercase tracking-widest">{user.role}</span>
                                <span className="px-4 py-2 bg-blue-50 text-blue-600 rounded-xl text-xs font-black uppercase tracking-widest">Active Staff</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <form onSubmit={handleUpdate} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        type="text"
                                        className="w-full bg-gray-50 border-none rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:ring-2 focus:ring-slate-900 transition-all"
                                        value={name}
                    ...
                    <div className="bg-blue-600 p-10 rounded-[3rem] shadow-2xl text-white">
                        <h3 className="text-xl font-black mb-8">Account</h3>
                        <div className="space-y-6">
                            <div>
                                <p className="text-[10px] font-black uppercase text-blue-200 tracking-widest mb-1">Username</p>
                                <p className="font-bold text-lg">{user.username}</p>
                            </div>
                            <div>
                                <p className="text-[10px] font-black uppercase text-blue-200 tracking-widest mb-1">User Role</p>
                                <p className="font-bold text-lg uppercase tracking-tight">{user.role}</p>
                            </div>
                        </div>
                    </div>
                </div>
